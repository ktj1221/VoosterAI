...
Next.js 15, shadcn, lucide-react, Typescript, tailwindcss, Supabase, @tanstack/react-query, es-toolkit, date-fns, PostgreSQL, Supabase Auth, Realtime notifications, Realtime collaboration
